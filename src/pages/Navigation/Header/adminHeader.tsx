...
import { CloseOutlined, MenuOpen, Notifications, Settings } from "@mui/icons-material";
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className="sm:grow">
                <div className="flex items-center justify-end space-x-3">
                  <Badge classes={{ badge: "!text-[9px]" }} badgeContent={5} overlap="circular" color="error" anchorOrigin={{ vertical: "top", horizontal: "right" }}>
                    <div className="border rounded-lg size-7 text-center">
                      <Tooltip title="Notifications">
                        <Notifications className="header-icon-mui-border" />
                      </Tooltip>
                    </div>
                  </Badge>
                  <div className="border rounded-lg size-7 text-center">
                    <Tooltip title="Settings">
                      <Settings className="header-icon-mui-border" />
                    </Tooltip>
                  </div>
                </div>
              </div>
